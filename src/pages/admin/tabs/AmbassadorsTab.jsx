    ...
    <div className="space-y-6">
      ...
      <div className="bg-white p-4 rounded-xl border border-neutral-200/80 shadow-sm space-y-3">
        <div className="flex flex-col lg:flex-row gap-3 items-stretch lg:items-center justify-between">
          {/* Status Pill Tabs */}
          <div className="flex items-center gap-1.5 p-1 bg-neutral-100 rounded-xl overflow-x-auto max-w-full scrollbar-none text-xs font-semibold text-neutral-600">
            {[
              ...
              <button
                ...
                className={`shrink-0 whitespace-nowrap inline-flex items-center gap-1.5 px-3.5 py-2 min-h-[38px] rounded-lg transition ${
                  statusFilter === tab.id
              ...
              >
                <span>{tab.label}</span>
                <span className="shrink-0 inline-flex items-center justify-center min-w-[20px] ml-1 px-1.5 py-0.5 text-[10px] font-bold rounded-full bg-neutral-200/80">
                  {tab.count}
                </span>
              </button>
            ))}
                ...
                {items.map((ca) => {
                  ...
                  return (
                    <tr key={ca._id} className="hover:bg-neutral-50/60 transition group">
                      <td className="sticky left-0 z-10 bg-white group-hover:bg-neutral-50 shadow-[1px_0_0_0_#E5E7EB] py-3 px-4 min-w-[180px]">
