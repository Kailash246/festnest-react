...
const AdminStatTilesSkeleton = () => (
  <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3.5">
    {[1, 2, 3, 4, 5].map((i) => (
      <div key={i} className="rounded-2xl border border-neutral-200/80 bg-white p-4 sm:p-5 flex flex-col justify-between shadow-xs min-h-[118px]">
        <div className="flex items-center justify-between mb-2">
          <div className="skeleton w-8 h-8 sm:w-9 sm:h-9 rounded-xl" />
          <div className="skeleton w-12 h-4 rounded-full" />
        </div>
        <div className="space-y-1.5">
          <div className="skeleton h-7 w-20 rounded-lg" />
          <div className="skeleton h-3.5 w-24 rounded" />
          <div className="skeleton h-2.5 w-16 rounded opacity-70" />
        </div>
      </div>
    ))}
  </div>
...
const AdminChartsSkeleton = () => (
  <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
    <div className="lg:col-span-2 bg-white p-5 sm:p-6 rounded-2xl border border-neutral-200/80 shadow-sm flex flex-col justify-between">
      ...
      <div className="skeleton w-full h-60 rounded-xl mt-2" />
    </div>
...
const AdminFeedsSkeleton = () => (
  <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
    {[1, 2].map((col) => (
      <div key={col} className="bg-white p-5 sm:p-6 rounded-2xl border border-neutral-200/80 shadow-sm space-y-4">
        ...
        <div className="space-y-2.5">
          {[1, 2, 3, 4].map((i) => (
            <div key={i} className="p-3.5 rounded-xl border border-neutral-100 flex items-center justify-between gap-3">
...
export default function OverviewTab({
  ...
  const isLongWait = useLongWait(loading && !stats);
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Primary KPI Grid */}
      <ProgressiveSection
        wrapperKey="admin-kpis"
        isLoading={!stats?.totals}
        skeleton={<AdminStatTilesSkeleton />}
      >
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3.5">
          <StatCard
      ...
      <ProgressiveSection
        wrapperKey="admin-charts"
        isLoading={!stats}
        skeleton={<AdminChartsSkeleton />}
      >
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
      ...
      <ProgressiveSection
        wrapperKey="admin-feeds"
        isLoading={!stats}
        skeleton={<AdminFeedsSkeleton />}
      >
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
